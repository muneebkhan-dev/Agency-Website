...
const Hero = () => {
  return (
    <section className='relative flex bg-[#222831]'>
      <div className='cont-1 relative min-h-117 md:min-h-110 lg:min-h-105 mx-auto'>
        <div className='hero-sec max-w-7xl px-8 lg:px-15 mx-auto mt-10 md:mt-13 lg:mt-10 w-full flex items-center md:text-center lg:text-start flex-col lg:flex-row text-[#FFFFFF] md:gap-2 lg:gap-20'>
          <div className='w-full md:2/3 lg:w-1/2'>
            <h1 className='heading text-3xl md:text-5xl lg:text-6xl leading-8 md:leading-15 lg:leading-17 font-playfair font-semibold '>
              We are <span className='text-[#00D0B0]'>always</span> there for
              all your needs
            </h1>
          </div>
          <div className=' md:w-2/3 lg:w-1/2 flex flex-col my-5 gap-6 md:gap-10'>
